...
"app.firstRegistrationForm.passwordRegEx": `В пароле присутствует недопустимый символ. Пароль должен быть от ${minSymbol} до ${maxSymbol} символов; заглавные или строчные латинские буквы (a–z, A–Z); цифры от 0 до 9; символы ! # $ % & ' * + - / = ? ^ _  { | } ~`,
